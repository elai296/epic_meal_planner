      ...
      <div>
        <div className="container textFont mt-5">
          <div className="row justify-content-center">
            <button className="btn btn-secondary" onClick={props.changeView}>
              Week View
            </button>
          </div>
              ...
              <div
                onClick={() => {
                  if (props.meal[props.mealObj.breakfast].recipe_id) {
                    props.recipeLink(
                      props.meal[props.mealObj.breakfast].recipe_label
                    );
                  }
                }}
              >
          ...
          <div className="row justify-content-center my-5">
            <div className="card col-4 mealTitle mx-2 text-center">Lunch</div>
            <div className="card col-6 mealRecipe mx-2 text-center">
              <div
                onClick={() => {
                  if (props.meal[props.mealObj.lunch].recipe_id) {
                    props.recipeLink(
                      props.meal[props.mealObj.lunch].recipe_label
                    );
                  }
                }}
              >
          ...
          <div className="row justify-content-center my-5">
            <div className="card col-4 mealTitle mx-2 text-center">Dinner</div>
            <div className="card col-6 mealRecipe mx-2 text-center">
              <div
                onClick={() => {
                  if (props.meal[props.mealObj.dinner].recipe_id) {
                    props.recipeLink(
                      props.meal[props.mealObj.dinner].recipe_label
                    );
                  }
                }}
              >
