...
function CalendarTable(props){
  return (
    <table className="table table-bordered text-center">
      ...
      <tbody>
        <tr>
          <th scope="row" className={props.date} >Sun<br /> {props.date[8]}{props.date[9]}</th>
        ...
        <tr>
          <th scope="row" className={props.setDate(1)}>Mon<br /> {(props.setDate(1))[8]}{(props.setDate(1))[9]} </th>
        ...
        <tr>
          <th scope="row" className={props.setDate(2)}>Tues<br /> {(props.setDate(2))[8]}{(props.setDate(2))[9]} </th>
        ...
        <tr>
          <th scope="row" className={props.setDate(3)}>Wed<br /> {(props.setDate(3))[8]}{(props.setDate(3))[9]} </th>
        ...
        <tr>
          <th scope="row" className={props.setDate(4)}>Thurs<br /> {(props.setDate(4))[8]}{(props.setDate(4))[9]} </th>
        ...
        <tr>
          <th scope="row" className={props.setDate(5)}>Fri<br />{(props.setDate(5))[8]}{(props.setDate(5))[9]}</th>
        ...
        <tr>
          <th scope="row" className={props.setDate(6)}>Sat<br />{(props.setDate(6))[8]}{(props.setDate(6))[9]}</th>
